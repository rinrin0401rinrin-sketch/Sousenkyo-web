...
const fixesPath = path.join(reviewRoot, "manual-fix", "manual-reading-mixed-fix-candidates.csv");
const reportPath = path.join(
  reviewRoot,
  "manual-fix",
  dryRun ? "manual-reading-mixed-apply-dry-run.csv" : "manual-reading-mixed-apply-report.csv",
);
...
console.log(`${dryRun ? "Dry-run checked" : "Applied"} ${reportRows.length} mixed reading fix(es)`);
