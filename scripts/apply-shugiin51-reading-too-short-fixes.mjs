...
const fixesPath = path.join(reviewRoot, "manual-fix", "manual-reading-too-short-fix-candidates.csv");
const reportPath = path.join(
  reviewRoot,
  "manual-fix",
  dryRun ? "manual-reading-too-short-apply-dry-run.csv" : "manual-reading-too-short-apply-report.csv",
);
...
console.log(`${dryRun ? "Dry-run checked" : "Applied"} ${reportRows.length} too-short reading fix(es)`);
