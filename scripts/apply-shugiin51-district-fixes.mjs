...
const fixesPath = path.join(reviewRoot, "manual-fix", "pending-district-fix-candidates.csv");
const reportPath = path.join(
  reviewRoot,
  "manual-fix",
  dryRun ? "pending-district-apply-dry-run.csv" : "pending-district-apply-report.csv",
);
...
console.log(`${dryRun ? "Dry-run checked" : "Applied"} ${reportRows.length} district fix(es)`);
