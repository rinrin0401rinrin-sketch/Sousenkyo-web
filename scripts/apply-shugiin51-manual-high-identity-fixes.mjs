...
const fixesPath = path.join(reviewRoot, "manual-fix", "manual-high-identity-fix-candidates.csv");
const reportPath = path.join(
  reviewRoot,
  "manual-fix",
  dryRun ? "manual-high-identity-apply-dry-run.csv" : "manual-high-identity-apply-report.csv",
);
...
console.log(`${dryRun ? "Dry-run checked" : "Applied"} ${reportRows.length} manual high-identity fix(es)`);
